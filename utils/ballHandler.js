...
// Sticker file IDs for each result type
const RESULT_STICKERS = {
  skull:  "CAACAgIAAxkBAAIBsWf8AAGmMqtGPiD2wFEV_example_skull",  // 💀 wicket
  fire:   "CAACAgIAAxkBAAIBsWf8AAGmMqtGPiD2wFEV_example_fire",   // 🔥 4,5,6
  fist:   "CAACAgIAAxkBAAIBsWf8AAGmMqtGPiD2wFEV_example_fist",   // 🤜 0,1,2,3
};
...
"💥 Wicket!\n\n👉 /batter [number] new batter",
    ...
    if (!overEnded) await advanceGame(match);const { randomLine, getBowlingCall, getBattingCall, getHattrickCall, randomMilestoneLine, randomGif } = require("../commentary");
const box = require("../utils/boxMessage");
