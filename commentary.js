...
const hattrickPrompts = [
  "🎩 HATTRICK BALL!\nThree wickets in a row — can you make history?",
  "🔥 Three in three!\nOne more and it's legendary!",
  "💀 Batter beware!\nThe bowler is on a hattrick!",
  "⚡ HATTRICK CHANCE!\nThis is the moment — deliver it!",
  "🏆 History on the line!\nHattrick ball — give it everything!"
];
...
function getHattrickCall() {
  return {
    text: pick(hattrickPrompts),
    gif: pick(gifs.hattrickCall)
  };
}
